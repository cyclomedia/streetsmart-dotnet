...
namespace StreetSmart.WPF.Example
{
    public class MainWindowModel: NotifyPropertyChanged
    {
        ...
        public MainWindowModel()
        {
            ...
            ApiKey = "Wfwx2DUFWDA1-7I1yDUB-PEJK7YxeTEVWrAh6nYlO3AtKfk9SnQBiz05eToNiTcl";
        }
        ...
        private async void ApiReady(object sender, EventArgs args)
        {
           ...
           ? OptionsFactory.Create(Username, Password, ApiKey, Srs, Language, addressSettings, element)
           : OptionsFactory.Create(Username, Password, "DAC6C8E5-77AB-4F04-AFA5-D2A94DE6713F", ApiKey, Srs, Language, ConfigurationUrl,
            addressSettings, element, loginOauth: true);
